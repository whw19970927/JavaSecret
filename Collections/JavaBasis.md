...
匿名内部类就是没有名字的内部类，日常开发中使用的比较多。示例如下：

![Image text](https://mubu.com/document_image/d26b4341-ac4d-4e38-ad0e-637500ef3d40-4943374.jpg)
...
## 30、局部内部类和匿名内部类访问局部变量的时候，为什么变量必须要加上final？

先看这段代码：

![Image text](https://mubu.com/document_image/948e6462-e615-4816-b552-b0816d93a234-4943374.jpg)
...
方法的重载和重写都是实现多态的方式，区别在于前者实现的是编译时的多态性，而后者实现的是运行时的多态性。同时两者也对应着JVM的动态分派和静态分派，也就是运行时和编译时的区别。
